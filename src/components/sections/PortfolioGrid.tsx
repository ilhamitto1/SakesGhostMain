    ...
    >
      {projects.map((project) => (
        ...
        >
          <div className="relative aspect-[16/10] overflow-hidden">
            ...
            <motion.div className="absolute left-3 top-3 flex flex-wrap gap-2">
              <span
      ...
      >
        ...
        <p className="text-sm font-semibold text-white">
          {t.buttons.yourProjectNext}
        </p>
        <p className="mt-2 text-sm text-slate-400">
          {t.buttons.yourProjectDesc}
        </p>
        <WhatsAppLink className="btn-secondary mt-5 whitespace-nowrap text-sm !px-5 !py-2.5">
