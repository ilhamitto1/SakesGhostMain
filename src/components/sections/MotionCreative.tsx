        ...
        <div className="mt-14 grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          {MOTION_ITEMS.map((item, index) => (
            <motion.div
              ...
              className={`group relative overflow-hidden rounded-2xl border border-white/[0.08] bg-gradient-to-br from-white/[0.06] to-transparent p-6 backdrop-blur-xl transition-transform duration-300 hover:-translate-y-1 ${
            ...
            >
              ...
              {index === 0 && (
                <div className="mt-6 flex aspect-video items-center justify-center rounded-xl border border-white/10 bg-gradient-to-br from-ghost-deep to-purple-950/50">
                  <div className="flex h-14 w-14 items-center justify-center rounded-full bg-white/10 ring-2 ring-purple-500/30">
